...
\begin{itemize}
  ...
  \item<2-> Compare model versions \emph{subtracting} their activity graphs\only<2-2>{\\\begin{center}\begin{minipage}[c][\graphASize]{\textwidth}\begin{center}\graphA {\Huge -} \includegraphics[scale=0.13]{images/feedback_params_graphD}\end{center}\end{minipage}\xdash[12em]\\ \includegraphics[scale=0.1]{images/difference_network_d-a_larger}\end{center}}
\end{itemize}
